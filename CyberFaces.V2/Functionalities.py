...
# é ao mesmo tempo que o rosto é salvo? se eu mover o rosto vai mudar a coordenada?
def save_coordenadas(coordenadas):
    coordenadas_folder = "coordenadas"
    file_path = '.\coordenadas\coordenadas.txt'

    if not os.path.exists(coordenadas_folder):
        os.makedirs(coordenadas_folder)
...
def load_coordenadas():
    ...
    if os.path.exists(file_path):
        with open(file_path, 'r') as file:
            for line in file:
                coordenada = ast.literal_eval(line.strip())
